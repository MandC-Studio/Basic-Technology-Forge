...
import cn.org.snowskystudio.basictechnology.block.entity.PressMachineBlockEntity;
import cn.org.snowskystudio.basictechnology.util.slots.ReadOnlySlot;
...
public class PressMachineMenu extends AbstractContainerMenu {
    public final PressMachineBlockEntity blockEntity;
    ...
    public PressMachineMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 41, 31));
            this.addSlot(new ReadOnlySlot(iItemHandler, 1, 115, 31));
        });
